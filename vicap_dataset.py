...
class CustomDataset(Dataset):
    ...
    def __init__(self, root_dir, captions_file, vicap_file=None, transform=None, freq_threshold=1):
        ...
        if vicap_file is None:
            vicap_file = resolve_ktvic_paths()['vocab_source']
...
def get_datasets(resize_name='maxwh', size=(384, 640), randaug=False, max_train_items=0, max_valid_items=0, max_test_items=0, split_mode='full', dev_split='seed42_valid10'):
    ...
    train_dataset = CustomDataset(root_dir=paths['train_images'], captions_file=paths['train_json'], vicap_file=paths['vocab_source'], transform=transforms['train'])
    valid_dataset = CustomDataset(root_dir=paths['valid_images'], captions_file=paths['valid_json'], vicap_file=paths['vocab_source'], transform=transforms['valid'])
    test_dataset = CustomDataset(root_dir=paths['test_images'], captions_file=paths['test_json'], vicap_file=paths['vocab_source'], transform=transforms['valid'])
    train_dict_dataset = DictDataset(root_dir=paths['train_images'], captions_file=paths['train_json'], vicap_file=paths['vocab_source'], transform=transforms['train'])
    valid_dict_dataset = DictDataset(root_dir=paths['valid_images'], captions_file=paths['valid_json'], vicap_file=paths['vocab_source'], transform=transforms['valid'])
    test_dict_dataset = DictDataset(root_dir=paths['test_images'], captions_file=paths['test_json'], vicap_file=paths['vocab_source'], transform=transforms['valid'])
